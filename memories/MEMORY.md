...
- read_paper 相关论文定位与 PDF 图表截图的核心实现归属于 `skills/productivity/read_paper/scripts/`；`tools/paper_locator_tool.py` 与 `tools/pdf_snapshot_tool.py` 仅作为全局工具注册 wrapper，调用 skill-local scripts。
