...
def _direct_write_support_context(root: Path, target: str, max_chars: int = 2200) -> dict:
    ...
    candidates = [
        ...
        *(eval_import_targets(root) or ["solution.py"]),
        # A failed run's real stderr/traceback must be the first thing the model
        # sees: fixing what crashed comes before any metric optimization.
        ".auto/run_failure.md",
        ".autoresearch/experiment_memory.md", ".autoresearch/experiment_memory.json",
        ".autoresearch/regression_cases.json",
        ".auto/eval_contract.md", ".auto/failure_digest.md", ".auto/execute_validation.md",
        ".auto/run_report.md", "program.md",
    ]
